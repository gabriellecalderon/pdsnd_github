...
def load_data(city, month, day):
    ...
    # make a new column for travel time
...
def time_stats(df):
    ...
    Calculates most popular month, day of the week, and hour to
    start bike trips."""
...
def station_stats(df):
    ...
    Calculates most popular start and end stations, as well as the
    endpoints for the most popular bike trip."""
...
def trip_duration_stats(df):
    ...
    Calculates total and average trip time from teh selected data."""
...
def user_stats(df):
    ...
    Calculates a summary of user types, and then a summary of user genders
    and some stats on birth year if the input data is available."""
